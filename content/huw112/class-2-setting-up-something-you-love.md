...
- **Office hours**: Tuesdays 12:30–1:30. Email me to schedule a time:
  jeffrey.ong97@lagcc.cuny.edu
- **Wi-Fi**: instructions for connecting are here:
  https://www.laguardia.edu/student-help/
- **CUNY email**: make sure you can log into your CUNY email — you'll use this same
  account both for OneDrive and to sign up for Figma. Login instructions:
...
- **Toolbar** (top of the screen) — where you pick your tool: shapes, text, the
  frame tool, and more.
- **Left sidebar** — lists your layers and pages, i.e. everything you've placed
  on the canvas so far.
- **Right sidebar** — shows the properties of whatever you currently have
  selected (size, color, font, position, etc).
- **Canvas** — the open workspace in the middle where you actually place and
  arrange things.

One term you'll hear a lot: a **frame**. Think of a frame as a fixed-size
container you draw on the canvas — like a sheet of paper or a picture frame —
that holds your design. You'll create one frame for today's activity.
